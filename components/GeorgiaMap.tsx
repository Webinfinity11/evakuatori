...
const CITIES: City[] = [
  { name: "თბილისი", x: 72.43, y: 74.2, hub: true },
  { name: "რუსთავი", x: 75.01, y: 80.83 },
  { name: "გორი", x: 61.7, y: 63.41 },
  { name: "თელავი", x: 82.08, y: 66.03 },
  { name: "ქუთაისი", x: 40.93, y: 52.08 },
  { name: "ზუგდიდი", x: 28.27, y: 42.45 },
  { name: "ფოთი", x: 25.3, y: 56.95 },
  { name: "ბათუმი", x: 24.85, y: 76.97 },
];
