...
export const metadata: Metadata = {
  ...
  description:
    "ევაკუატორის გამოძახება 24 საათი, კვირაში 7 დღე. თბილისში მისვლა 30 წუთში, ფასს ზარისთანავე გეტყვით. სტანდარტული, ობობა და ავარიული ევაკუატორი. დარეკეთ: 568 120 120",
  keywords: [
  ...
  openGraph: {
    ...
    description: "გამოძახება 24 საათი. თბილისში 30 წუთში. ფასს ზარისთანავე გეტყვით.",
    locale: "ka_GE",
    type: "website",
  },
};
